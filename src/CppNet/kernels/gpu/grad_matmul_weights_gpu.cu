...
__global__
void grad_weights_kernel(const float* X, const float* dY, float* dW, int batch, int in_size, int out_size)
{
...
void matmul_grad_weights_gpu(const float* X, const float* dY, float* dW,
